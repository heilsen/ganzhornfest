...
// CrashlyticsTree.log() overrides Timber.Tree's protected abstract method, which is not directly
// callable from outside the class. Routing through Timber.plant()/tag() exercises the real
// dispatch path instead of relying on reflection.
